...
const EXAM_ID = "cbse-class-10-english";
const EXAM_DISPLAY_NAME = "CBSE Class 10 English";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Reading, Writing & Grammar, and Literature (First Flight, Footprints Without Feet). Align to CBSE Class 10 English Language & Literature pattern.
