...
export const metadata: Metadata = {
  title: "Pricing — Cbse Class 10 English Premium",
  description: "Unlock unlimited Cbse Class 10 English practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=cbse-class-10-english&cadence=annual`;
